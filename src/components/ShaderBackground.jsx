...
export function ShaderBackground(test) {
  console.log("shader.props", test)
  // const dark = false
  const htmlDark = document.documentElement.classList.contains("dark") ?? false
  let [dark, setDark] = useState(htmlDark)

  document.addEventListener("astro:after-swap", () => {
    htmlDark = document.documentElement.classList.contains("dark") ?? false
  })
